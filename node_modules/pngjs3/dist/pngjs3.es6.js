...
var Inflate = /*#__PURE__*/function (_zlib$Inflate) {
  ...
  function Inflate(opts) {
    ...
    zlib.Inflate.call(_assertThisInitialized(_this), opts); // Node 8 --> 9 compatibility check
...
var PNG$1 = /*#__PURE__*/function (_Stream) {
  ...
  function PNG() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_postParsed", function () {
      _this.store = produce(_this.store, function (draft) {
    ...
    _this._parser.on('parsed', function (parsedData) {
      this.store = produce(this.store, function (draft) {
...
export { PNG, _adjustGamma as adjustGamma, _bitblt as bitblt, index as default, sync };
//# sourceMappingURL=pngjs3.es6.js.map
